...
| :--- | :--- | :--- |
| [Self-Evolving Agent](agents/self-evolving.md) | Designs and registers its own tools at runtime with a desktop GUI. | Gemini Flash, Ollama |
...
| [Caveman Compressor](agents/caveman.md) | Compresses verbose technical text into terse, efficient summaries. | Gemini Flash |
| [Tutorial Debug Agent](agents/tutorial-debug.md) | Interactive ADK tutorials and real-time terminal error debugging. | Gemini Flash |
...
| [Scientific Paper Writer](agents/scie-paper.md) | Publication-ready paper generation using a 5-agent pipeline. | Gemini Flash |
