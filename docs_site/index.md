...
| [Book Writer](agents/book-writer.md) | High-throughput book generation pipeline with GitHub auto-commit. | Gemini Flash, Ollama |
| [Course Generator](agents/course-generator.md) | Multilingual course creation via a 4-agent sequential pipeline. | Gemini Flash, Ollama |
| [Caveman Compressor](agents/caveman-compressor.md) | Compresses verbose technical text into terse, efficient summaries. | Gemini Flash, Ollama |
| [Tutorial Debug Agent](agents/tutorial-debug-agent.md) | Interactive ADK tutorials and real-time terminal error debugging. | Gemini Flash, Ollama |
...
| [Scientific Paper Writer](agents/scie_paper_writer.md) | Publication-ready paper generation using a 5-agent pipeline. | Gemini Flash, Ollama |
| [Tiny Company](agents/tiny-company.md) | Multi-agent simulation building a TOPIK learning assistant web app. | Gemini Flash, Ollama |
