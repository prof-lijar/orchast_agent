...
from app.tools.python_dev import (  # noqa: E402
    clean_for_init,
    run_pytest,
    run_ruff,
    uv_add,
...
architect_agent = Agent(
    ...
    tools=[
        *_shared_tools,
        ...
        close_issue,
        uv_init, uv_add, uv_add_dev, uv_run, clean_for_init,
        run_command,
    ],
)
...
backend_agent = Agent(
    ...
    tools=[
        *_shared_tools,
        ...
        git_commit_and_push, git_pull,
        create_pull_request,
        uv_add, uv_run, run_pytest, run_ruff,
        run_command,
    ],
)
