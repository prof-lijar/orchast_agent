"""Git operations for tiny-jarvis agents."""
...
def git_commit_and_push(message: str, files: str = ".") -> str:
    ...
    Args:
        message: Commit message. Prefix with your role tag, e.g. '[Backend] Add db_tool module'.
...
def git_create_branch(branch_name: str) -> str:
    ...
    Args:
        branch_name: The branch name. Use format: role/description (e.g., 'backend/add-db-tool').
...
def git_switch_branch(branch_name: str) -> str:
    ...
    Args:
        branch_name: The branch to switch to (e.g., 'main', 'backend/add-parser').
...
def run_command(command: str) -> str:
    ...
    Args:
        command: The shell command to execute (e.g., 'uv run pytest', 'python main.py --help').
