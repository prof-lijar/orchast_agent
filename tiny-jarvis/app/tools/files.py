"""File read/write tools for tiny-jarvis agents."""
...
_PROTECTED_NAMES = {".git", ".env", ".env.local"}
...
def read_file(file_path: str) -> str:
    """Read the contents of a file in the product repository.

    Args:
        file_path: Relative path from the repo root (e.g., 'main.py', 'tools/db_tool.py').
...
def write_file(file_path: str, content: str) -> str:
    """Write or overwrite a file in the product repository. Creates parent directories if needed.

    Args:
        file_path: Relative path from the repo root (e.g., 'tools/db_tool.py').
...
def list_directory(dir_path: str = ".") -> str:
    """List files and directories at a given path in the product repository.
...
def delete_file(file_path: str) -> str:
    """Delete a file from the product repository.
...
def search_files(query: str, file_pattern: str = "*.py") -> str:
    """Search for text across files in the product repository.
