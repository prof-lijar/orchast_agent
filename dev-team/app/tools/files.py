"""File read/write tools for dev-team agents."""
...
def read_file(file_path: str) -> str:
    ...
    Args:
        file_path: Relative path from the repo root (e.g., 'src/app/page.tsx', 'README.md').
...
def write_file(file_path: str, content: str) -> str:
    ...
    Args:
        file_path: Relative path from the repo root (e.g., 'src/components/Button.tsx').
...
def delete_file(file_path: str) -> str:
    ...
    Args:
        file_path: Relative path from the repo root (e.g., 'src/old-component.tsx').
...
def search_files(query: str, file_pattern: str = "*") -> str:
    """Search for text across all files in the product repository.
