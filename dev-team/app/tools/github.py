"""GitHub CLI wrapper tools for dev-team agents."""
...
def list_open_issues(label: str = "", limit: int = 20) -> str:
    ...
    Args:
        label: Optional label to filter by (e.g., 'role:frontend', 'P0-critical').
...
def create_issue(title: str, body: str, labels: str = "") -> str:
    ...
    Args:
        ...
        labels: Comma-separated labels (e.g., 'role:frontend,P1-high,status:todo').
